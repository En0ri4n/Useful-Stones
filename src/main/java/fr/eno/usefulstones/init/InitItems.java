...
import fr.eno.usefulstones.item.ItemBlock;
...
public class InitItems
{
	...
	public static final RegistryObject<Item> BLUESTONE_ORE = ITEMS.register("bluestone_ore", () -> new ItemBlock(InitBlocks.BLUESTONE_ORE.get()));

	public static final RegistryObject<Item> BLUESTONE_INFUSER = ITEMS.register("bluestone_infuser", () -> new ItemBlock(InitBlocks.BLUESTONE_INFUSER.get()));
